...
import com.maxieds.MifareClassicToolLibrary.BuildConfig;
...
public class MainActivity extends AppCompatActivity implements MifareClassicDataInterface {
     ...
     protected void onCreate(Bundle savedInstanceState) {
          ...
          if (hasReadExternalPermission != PackageManager.PERMISSION_GRANTED) {
               String[] reqestedPermissions = new String[] { Manifest.permission.READ_EXTERNAL_STORAGE };
          ...
          if (hasWriteExternalPermission != PackageManager.PERMISSION_GRANTED) {
               String[] reqestedPermissions = new String[] { Manifest.permission.WRITE_EXTERNAL_STORAGE };
               requestPermissions(reqestedPermissions, REQUEST_CODE_ASK_PERMISSIONS);
          }
          ...
          Log.i(TAG, "Library" + " up and running AT " + MCTUtils.GetTimestamp());
